# Runtime Slice-02B Projection Intake Artifact Index
...
| `tests/_scratch/runtime-slice-02-readonly-plan-bridge/runs/pos_projection_intake_run1.json` | Projection-intake positive output (run 1) | Joined-preview deterministic source A |
| `tests/_scratch/runtime-slice-02-readonly-plan-bridge/runs/pos_projection_intake_run2.json` | Projection-intake positive output (run 2) | Joined-preview deterministic source B |
