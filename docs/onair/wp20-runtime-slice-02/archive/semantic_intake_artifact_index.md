# Runtime Slice-02C Semantic Interpretation Intake Artifact Index
...
| `tests/wp-19/target-03/fixtures/projection_pass_case.json` | Projection-intake positive fixture | Slice-02B carry-forward and semantic joined-preview input |
...
| `tests/_scratch/runtime-slice-02-readonly-plan-bridge/fixtures/projection_malformed_missing_semantic_scope.json` | Semantic-intake negative fixture | Verifies missing `scope_resolution` fail-closed behavior |
| `tests/_scratch/runtime-slice-02-readonly-plan-bridge/fixtures/projection_malformed_empty_semantic_evidence_source.json` | Semantic-intake negative fixture | Verifies empty `evidence_source` fail-closed behavior |
...
| `tests/_scratch/runtime-slice-02-readonly-plan-bridge/runs/pos_projection_intake_run1.json` | Semantic-intake positive output (run 1) | Joined-preview deterministic source A |
| `tests/_scratch/runtime-slice-02-readonly-plan-bridge/runs/pos_projection_intake_run2.json` | Semantic-intake positive output (run 2) | Joined-preview deterministic source B |
...
| `SmartStat_v4.1.0.vbs` | Validated runtime surface containing slice-02 gated region | Confirms bounded read-only semantic-intake runtime scope |
