...
|---|---|---|
| Scope drift outside read-only rule-evaluation-summary intake | Stop rehearsal and mark fail | yes |
...
| Any implied rule-evaluation execution behavior | Stop rehearsal and mark fail | yes |
| Any implied ordered-rules rendering expansion beyond bounded read-only summary intake | Stop rehearsal and mark fail | yes |
