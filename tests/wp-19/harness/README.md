...
6. Strict projection-to-view-model adapter mapping with deterministic read-only output.
...
- `python tests/wp-19/harness/projection_to_view_model_adapter_contract_test.py`
